...
//255, 192, 64     120, 185, 252
color C1 = color(120, 185, 252);
color C2 = color(random(255), random(255), random(255));//color(255, 192, 64);
color C3 = color(120, 185, 252);
color C4 = color(255);
//color C1 = color(255, 255, 255);
//color C2 = color(0, 0, 0);
//color C3 = color(0, 0, 0);
//color C4 = color(random(255), random(255), random(255));
int AmountOfPointsX = 100 + 2;
int AmountOfPointsY = 50 + 2;
...
void keyReleased() {
  ...
  if (keyCode == 122) {
    ScreenShots.add(new ClassScreenShotSave("ScreenShots/BackgroundCC", ".png", "Images/IconCameraV_3.png", 10, 10, 35, -2.5)); //"ScreenShots/ScreenShotNumData.txt", 
  }
